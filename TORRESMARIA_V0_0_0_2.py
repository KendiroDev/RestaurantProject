...
# Pequeno menu para ter controle de quando começar ou sair do programa 
while contador != 2:
    contador = 0
    print('*'*45)
    print(' ')
    print(' 1 - COMEÇAR A CONTAGEM DE VALORES')
    print(' 2 - ENCERRAR O PROGRAMA E DAR RELATORIO')
    print(' ')
    print('*'*45)
    print(' ')
    ...
    if contador == 1:
        ...
        print(' ')
        print('='*71)
# Um arquivo de texto para mostrar o nome do restaurante
        print("""
...
|_   _/ _ \|  _ \|  _ \| ____/ ___||  \/  |  / \  |  _ \|_ _|  / \    |
  ...
  """)
        ...
        print(' ')
        print(' ')
# somar com a comanda feita durante o expediente
        # nome.append(input('Qual o nome do dono da comanda quantas pessoas?: '))
...
# vai calcular a quantidade de itens selecionado vezes o valor do item
...
# calcular todo o valor gasto no restaurante
...
# relatorio feito para saber quantos itens foram consumidos no dia 
...
# string para mostrar qual o valor sera pago pelo cliente 
...
# relatorio do dia para o controle de estoque
    else:
        print(' ')
        print(' ')
        print(' ')
        ...
        print(' ')
        print(' ')
        print('Vieram o total de {} adultos e {} crianças'.format(nref,nmeia))
